module DistributeReads
  module GlobalMethods
    def distribute_reads(**options)
      ...
      unknown_keywords = options.keys - [:allow_writes, :failover, :lag_failover, :lag_on, :max_lag, :primary]
      ...
      begin
        Thread.current[:distribute_reads] = {allow_writes: options[:allow_writes], failover: options[:failover], primary: options[:primary]}
